<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProxyUserInformation.aspx.cs" Inherits="ProxyUserInformation" %>
	...
	<div class="breadcrumb-agile">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb m-0">
				...
				<li class="breadcrumb-item active" aria-current="page">End User Information</li>
			</ol>
		</nav>
	</div>
	<!-- //page details -->
			...
			<div  align="center">
				...
				<div >
					<div class="address-grid">
						<h4 class="font-weight-bold mb-3">End User Information</h4>
						<form id="form1" runat="server">
                            <table>
                                <tr>
                                   <div class="form-group">
                                       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Font-Size="15pt" DataSourceID="SqlDataSource1">
                                           <Columns>
							        ...
							        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AuditDataConnectionString %>" SelectCommand="SELECT [MailID], [Name], [MobileNumber], [Date] FROM [EndUserDetails] ORDER BY [ID] DESC"></asp:SqlDataSource>

...
public partial class EndUserRegister : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con1.Open();
        cmd = new SqlCommand("select * from EndUserDetails where MobileNumber='" + TextBox5.Text + "'", con1);
        ...
        {
            con2.Open();
            cmd = new SqlCommand("select * from EndUserDetails where MailID='" + TextBox1.Text + "'", con2);
            ...
            {
                con3.Open();
                cmd = new SqlCommand("insert into EndUserDetails values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','" + date + "')", con3);
                cmd.ExecuteNonQuery();
                con3.Close();

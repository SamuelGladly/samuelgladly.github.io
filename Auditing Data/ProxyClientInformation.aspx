<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProxyClientInformation.aspx.cs" Inherits="ProxyClientInformation" %>
                            ...
                            <table>
                                <tr>
                                   <div class="form-group">
							        ...
							        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AuditDataConnectionString %>" SelectCommand="SELECT [MailID], [Name], [MobileNumber], [Date], [Status] FROM [ClientDetails] ORDER BY [ID] DESC"></asp:SqlDataSource>
							       </div>
                                </tr>

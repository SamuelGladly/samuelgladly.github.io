<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EndUserFileKey.aspx.cs" Inherits="EndUserFileKey" %>
	...
	<div class="breadcrumb-agile">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb m-0">
				...
				<li class="breadcrumb-item active" aria-current="page">File Key</li>
			</ol>
		</nav>
	</div>
	<!-- //page details -->
			...
			<div  align="center">
				...
				<div >
					<div class="address-grid">
						<h4 class="font-weight-bold mb-3">File Key</h4>
						<form id="form1" runat="server">
                            <table>
                                ...
                                <tr>
                                   <div class="form-group">
                                       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" Font-Size="15pt"  style="text-align: center" DataSourceID="SqlDataSource1">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AuditDataConnectionString %>" SelectCommand="SELECT [UserName], [FileName], [FileKey], [Date] FROM [FileRequest] WHERE (([UserMailID] = @UserMailID) AND ([FileKey] != @FileKey)) ORDER BY [ID] DESC">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="TextBox1" Name="UserMailID" PropertyName="Text" Type="String" />
                                            <asp:Parameter DefaultValue="Waiting" Name="FileKey" Type="String" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                   </div>
                                </tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KGCUserRequest.aspx.cs" Inherits="KGCUserRequest" %>
			...
			<div  align="center">
				...
				<div >
					<div class="address-grid">
						<h4 class="font-weight-bold mb-3">User Key Request</h4>
                            ...
                            <table>
                                <tr>
                                   <div class="form-group">
							        ...
							        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AuditDataConnectionString %>" SelectCommand="SELECT [UserName], [FileName], [Status], [Date] FROM [FileRequest] ORDER BY [ID] DESC"></asp:SqlDataSource>

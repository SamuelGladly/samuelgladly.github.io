			...
			<div  align="center">
				...
				<div >
					<div class="address-grid">
						<h4 class="font-weight-bold mb-3">Client Login</h4>
						<form action="#" method="post" runat="server">
                            <table>
                                <tr>
                                   <div class="form-group">
                                   <asp:TextBox ID="TextBox1" runat="server"  class="form-control" placeholder="Client Mail ID" required="" Height="50" Width="400" style="text-align: center"></asp:TextBox>								
							       </div>
                                </tr>
                                <tr>
                                   <div class="form-group">

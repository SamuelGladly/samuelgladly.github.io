<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClientUploadFiles.aspx.cs" Inherits="ClientUploadFiles" %>
			...
			<div  align="center">
				...
				<div >
					<div class="address-grid">
						<h4 class="font-weight-bold mb-3">File Upload</h4>
						<form action="#" method="post" runat="server">
                            <table>
                                ...
                                <tr>
                                   <div class="form-group">
                                       <asp:FileUpload ID="FileUpload1" runat="server" class="form-control" required="" Width="400" style="text-align: center"/>
                                   </div>
                                </tr>

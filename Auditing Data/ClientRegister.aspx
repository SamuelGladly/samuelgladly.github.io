<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClientRegister.aspx.cs" Inherits="ClientRegister" %>
			...
			<div  align="center">
				...
				<div >
					<div class="address-grid">
						<h4 class="font-weight-bold mb-3">Client Register</h4>
						<form action="#" method="post" runat="server">
                            <table>
                                <tr>
                                   <div class="form-group">
                                   <asp:TextBox ID="TextBox1" runat="server"  class="form-control" placeholder="Mail ID" required="" Height="50" Width="400" style="text-align: center"></asp:TextBox>	
                                   <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Please Fill Valid Mail ID" ForeColor="Red" ControlToValidate="TextBox1" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ></asp:RegularExpressionValidator>							
							       </div>
                                </tr>
                                <tr>
                                   <div class="form-group">
                                ...
                                <tr>
                                   <div class="form-group">
                                   <asp:TextBox ID="TextBox3" runat="server"  class="form-control" placeholder="Confirm Password" required="" TextMode="Password" Height="50" Width="400" style="text-align: center"></asp:TextBox>	
                                ...
                                <tr>
                                   <div class="form-group">
                                   <asp:TextBox ID="TextBox4" runat="server"  class="form-control" placeholder="Name" required="" Height="50" Width="400" style="text-align: center"></asp:TextBox>								
							       </div>
                                </tr>
                                <tr>
                                  <div class="form-group">
                                   <asp:TextBox ID="TextBox5" runat="server"  class="form-control" placeholder="Mobile Number" required="" Height="50" Width="400" style="text-align: center" MaxLength="10"></asp:TextBox>	
                                   <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Please Fill Valid Mobile No" ForeColor="Red" ControlToValidate="TextBox5" ValidationExpression="[0-9]{10}"></asp:RegularExpressionValidator>							
							       </div>
                                </tr>
                                <tr>

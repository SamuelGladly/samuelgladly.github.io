<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchFiles.aspx.cs" Inherits="SearchFiles" %>
	...
	<div class="breadcrumb-agile">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb m-0">
				...
				<li class="breadcrumb-item active" aria-current="page">Search File</li>
			</ol>
		</nav>
	</div>
	<!-- //page details -->
			...
			<div  align="center">
				...
				<div >
					<div class="address-grid">
						<h4 class="font-weight-bold mb-3">File Search</h4>
                            ...
                            <table>
                                ...
                                <tr>
                                   <div class="form-group">
                                    ...
                                    <asp:Button ID="Button1" runat="server" Text="Open" Height="50" Width="400" OnClick="Button1_Click"/>
                               
                                 <tr><br /><br /><br />
                                   <div class="form-group">
                                   <asp:TextBox ID="TextBox1" runat="server"  class="form-control" placeholder="" Height="100" Width="500" TextMode="MultiLine"></asp:TextBox>	
                                   </div>
                                </tr>

                                 <asp:Button ID="Button2" runat="server" Text="Submit" Height="50" Width="400" OnClick="Button2_Click"/>
                                 </table>

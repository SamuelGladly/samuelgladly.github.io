<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KGCTransaction.aspx.cs" Inherits="KGCTransaction" %>
			...
			<div  align="center">
				...
				<div >
					<div class="address-grid">
						<h4 class="font-weight-bold mb-3">Transaction Information</h4>
                                ...
                                <tr>
                                   <div class="form-group">
							        ...
							        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AuditDataConnectionString %>" SelectCommand="SELECT [FileName], [Status], [UserName], [Date] FROM [AuditDetails] WHERE ([Status] = @Status) ORDER BY [ID] DESC">
                                        <SelectParameters>
                                            <asp:Parameter DefaultValue="Key Mismatch" Name="Status" Type="String" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>

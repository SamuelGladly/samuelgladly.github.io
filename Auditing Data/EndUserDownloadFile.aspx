<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EndUserDownloadFile.aspx.cs" Inherits="EndUserDownloadFile" %>
			...
			<div  align="center">
				...
				<div >
					<div class="address-grid">
						<h4 class="font-weight-bold mb-3">File Download</h4>
						<form action="#" method="post" runat="server">
                            <table>
                                ...
                                <tr>
                                   <div class="form-group">
                                   <asp:TextBox ID="TextBox3" runat="server"  class="form-control" placeholder="File Name" required="" Height="50" Width="400" style="text-align: center" ></asp:TextBox>	
                                   </div>
                                </tr>

                                <tr>
                                   <div class="form-group">
                                   <asp:TextBox ID="TextBox4" runat="server"  class="form-control" placeholder="File Key" required="" Height="50" Width="400" style="text-align: center" TextMode="Password"></asp:TextBox>	
                                   </div>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Button ID="Button1" runat="server" Text="File View" Height="50" Width="200" OnClick="Button1_Click"/>
                                    </td>
                                    <td>
                                        <asp:Button ID="Button2" runat="server" Text="File Download" Height="50" Width="200" OnClick="Button2_Click"/>
                                    </td>
                                </tr>
                                <tr>
                                    <asp:Button ID="Button3" runat="server" Text="File Send to Mail" Height="50" Width="400" OnClick="Button3_Click"/>
                                </tr>
                            </table><br /><br />
                            <asp:Panel ID="Panel1" runat="server" Visible="false" >
                            <table>
                                <asp:TextBox ID="t" runat="server" Text="Vicky@123" Visible="false"></asp:TextBox>
                                <tr>
                                    <asp:TextBox ID="TextBox5" runat="server"  class="form-control" placeholder="" Height="100" Width="500" TextMode="MultiLine" ReadOnly="true"></asp:TextBox>	
                                </tr>

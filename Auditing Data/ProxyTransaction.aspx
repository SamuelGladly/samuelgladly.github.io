<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProxyTransaction.aspx.cs" Inherits="ProxyTransaction" %>
                            ...
                            <table>
                                <tr>
                                   <div class="form-group">
                                       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Font-Size="14pt" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSourceID="SqlDataSource1" style="text-align: center" >
                                           <Columns>
							        ...
							        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AuditDataConnectionString %>" SelectCommand="SELECT [FileName], [Status], [UserName], [Date] FROM [AuditDetails] ORDER BY [ID] DESC"></asp:SqlDataSource>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EndUserLogin.aspx.cs" Inherits="EndUserLogin" %>
						...
						<form action="#" method="post" runat="server">
                            <table>
                                <tr>
                                   ...
                                   <asp:TextBox ID="TextBox1" runat="server"  class="form-control" placeholder="User Mail ID" required="" Height="50" Width="400" style="text-align: center"></asp:TextBox>								
							       </div>
                                </tr>
                                <tr>
                                   <div class="form-group">

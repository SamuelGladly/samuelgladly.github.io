<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CloudServerFiles.aspx.cs" Inherits="CloudServerFiles" %>
                            ...
                            <table>
                                 ...
                                 <tr>
                                   <div class="form-group">
                                     ...
                                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AuditDataConnectionString %>" SelectCommand="SELECT [ID], [ClientName], [FileName], [UploadFile], [Date] FROM [FileUpload] ORDER BY [ID] DESC"></asp:SqlDataSource>

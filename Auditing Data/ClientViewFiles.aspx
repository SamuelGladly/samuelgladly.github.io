<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClientViewFiles.aspx.cs" Inherits="ClientViewFiles" %>
...
<body>
			...
			<nav class="navbar navbar-expand-lg navbar-light">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-lg-auto text-lg-right text-center">
						...
						<li class="nav-item ">
							<a class="nav-link" href="ClientHome.aspx">HOME
								<span class="sr-only">(current)</span>
							</a>
						</li>
						<li class="nav-item ">
							<a class="nav-link" href="ClientUploadFiles.aspx">UPLOAD FILES</a>
						</li>
                        <li class="nav-item ">
							<a class="nav-link" href="ClientCheckData.aspx">CHECK DATA INTEGRITY</a>
						</li>
                        <li class="nav-item">
					...
					<div class="menu">
						...
						<div class="toggle">
							<ul class="toggle-menu list-unstyled">
								<li>
									<a href="ClientViewFiles.aspx">View Files</a>
								</li>
						...
						<form id="form1" runat="server">
                            <table>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                   <div class="form-group">
                                       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" Font-Size="15pt">
                                           <Columns>
                                               <asp:BoundField DataField="FileName" HeaderText="FileName" SortExpression="FileName" />
                                               <asp:BoundField DataField="UploadFile" HeaderText="UploadFile" SortExpression="UploadFile" />
                                               <asp:BoundField DataField="Date" HeaderText="Date" SortExpression="Date" />
                                               <asp:BoundField DataField="ClientStatus" HeaderText="ClientStatus" SortExpression="ClientStatus" />
                                     ...
                                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AuditDataConnectionString %>" SelectCommand="SELECT [FileName], [Date], [ClientStatus], [UploadFile] FROM [FileUpload] WHERE ([ClientMailID] = @ClientMailID) ORDER BY [ID] DESC">
                                         <SelectParameters>
                                             <asp:ControlParameter ControlID="TextBox1" Name="ClientMailID" PropertyName="Text" Type="String" />
                                         </SelectParameters>
                                     </asp:SqlDataSource>
                                   </div>
                                </tr>
	...
	<footer class="text-center py-sm-4 py-3">
		<div class="container py-xl-5 py-3">
			...
			ht my-lg-5 my-4 pb-4">© Cloud Audit Data. All Rights Reserved 

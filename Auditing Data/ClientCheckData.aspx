<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClientCheckData.aspx.cs" Inherits="ClientCheckData" %>
			...
			<div  align="center">
				...
				<div >
					<div class="address-grid">
						<h4 class="font-weight-bold mb-3">Check Data Integrity</h4>
                            ...
                            <table>
                                ...
                                <tr>
                                   <div class="form-group">
                                    ...
                                    <asp:Button ID="Button1" runat="server" Text="Check" Height="50" Width="400" OnClick="Button1_Click" />
                                </table>

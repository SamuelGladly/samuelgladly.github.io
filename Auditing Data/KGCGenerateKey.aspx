<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KGCGenerateKey.aspx.cs" Inherits="KGCGenerateKey" %>
	...
	<div class="breadcrumb-agile">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb m-0">
				...
				<li class="breadcrumb-item active" aria-current="page">Key Generate</li>
			</ol>
		</nav>
	</div>
	<!-- //page details -->
			...
			<div  align="center">
				...
				<div >
					<div class="address-grid">
						<h4 class="font-weight-bold mb-3">Key Generate</h4>
						<form id="form1" runat="server">
                            <table>
                                <tr>
                                   <div class="form-group">
                                       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" Font-Size="15pt" DataSourceID="SqlDataSource1"  style="text-align: center">
                                           <Columns>
                                              
                                               <asp:BoundField DataField="FileName" HeaderText="File Name" SortExpression="FileName" />
                                               <asp:BoundField DataField="UploadFile" HeaderText="Upload File" SortExpression="UploadFile" />
                                               <asp:BoundField DataField="Date" HeaderText="Date" SortExpression="Date" />
                                               <asp:BoundField DataField="FileKey" HeaderText="File Key" SortExpression="FileKey" />
							        ...
							        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AuditDataConnectionString %>" SelectCommand="SELECT [FileName], [UploadFile], [Date], [FileKey] FROM [FileUpload] ORDER BY [ID] DESC"></asp:SqlDataSource>
